...
docker run -e ARANGO_ROOT_PASSWORD=${ARPASSWORD} -d --name arangodb3-instance --net dockernet --ip 172.18.1.3 --volumes-from arangodb3-persist -p 9000:8529 arangodb/arangodb docker start -a arangodb3-instance --database.auto-upgrade
